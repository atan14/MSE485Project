...
boron_site = random.randint(1, num_atoms)

# if start at substitutional site, then we need to insert some vacancies in Ge lattice
if boron_site%2 == 0:
    for i in range(20):
        rn = random.randint(1, int(num_atoms/2))*2
        types[rn] = 'V'
